...
- Normality: Jarque-Bera and Shapiro-Wilk both reject normality. The fitted Student-t distribution improves AIC by 206.6 points relative to the Gaussian fit.
...
- Volatility model: Student-t GARCH(1,1) estimated on ARIMA residuals with alpha = 0.141, beta = 0.837, and persistence = 0.979. Estimated Student-t degrees of freedom = 6.94, reinforcing the heavy-tail interpretation.
