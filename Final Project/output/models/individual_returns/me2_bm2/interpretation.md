...
- Normality: Jarque-Bera and Shapiro-Wilk both reject normality. The fitted Student-t distribution improves AIC by 403.2 points relative to the Gaussian fit.
...
- Volatility model: Student-t GARCH(1,1) estimated on ARIMA residuals with alpha = 0.132, beta = 0.830, and persistence = 0.962. Estimated Student-t degrees of freedom = 7.17, reinforcing the heavy-tail interpretation.
