...
- Volatility model: Gaussian GARCH(1,1) estimates alpha = 0.140, beta = 0.839, and persistence = 0.980.
- Volatility clustering: raw ARCH-LM p-value = 0.0000; standardized-residual ARCH-LM p-value = 0.5653. ARCH effects are materially weaker after GARCH standardization.
