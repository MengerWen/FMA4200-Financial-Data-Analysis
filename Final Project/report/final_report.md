...
Each portfolio was analyzed with time-series plots, histogram-density plots, QQ plots, ACF/PACF, Jarque-Bera tests, ADF and KPSS tests, Ljung-Box diagnostics, and ARCH-LM tests. Detailed figures are kept in the appendix and the `output/figures/individual_returns/` folders so the main body can focus on the highest-signal results. The central finding is that the six series are stationary in levels but far from Gaussian, with visible tail risk and volatility clustering even at the monthly frequency.

**Table 3. Distribution, normality, stationarity, and ARCH diagnostics.**

| Portfolio | Skewness | Kurtosis | Jarque-Bera p | ADF p | ARCH-LM p |
| --- | --- | --- | --- | --- | --- |
| Small LoBM | 0.57 | 9.92 | <0.001 | <0.001 | <0.001 |
| ME1 BM2 | 1.10 | 16.41 | <0.001 | <0.001 | <0.001 |
| Small HiBM | 1.96 | 23.85 | <0.001 | <0.001 | <0.001 |
| Big LoBM | -0.13 | 8.20 | <0.001 | <0.001 | <0.001 |
| ME2 BM2 | 1.16 | 20.20 | <0.001 | <0.001 | <0.001 |
| Big HiBM | 1.44 | 20.45 | <0.001 | <0.001 | <0.001 |

Table 3 makes the distributional result hard to miss. Jarque-Bera p-values are effectively zero for all six portfolios, so Gaussian return innovations are not supported empirically. The most extreme non-normality appears in Small HiBM, which combines strong positive skewness with very high kurtosis. At the same time, ADF p-values strongly reject a unit root for every raw return series, which justifies modeling returns in levels rather than differencing them. ARCH-LM tests also reject homoskedasticity throughout the panel, with the strongest raw-volatility clustering in ME2 BM2.

### 3.2 ARIMA Benchmarks and GARCH-Type Volatility Models

Given the stationarity evidence, the mean-model search compared low-order AR, MA, and ARIMA specifications using AIC, BIC, residual Ljung-Box tests, and parameter significance. Because the `arch` package is unavailable in the required environment, the volatility step uses a lightweight Gaussian GARCH(1,1) estimator implemented with `scipy.optimize`. This fallback is narrower than the full `arch` ecosystem, but it is still suitable for comparing volatility persistence and checking whether standardized residuals retain ARCH effects.

**Table 4. Selected benchmark mean and volatility models.**

| Portfolio | Selected ARIMA | Residual Ljung-Box p (12) | GARCH persistence | Std. resid. ARCH-LM p |
| --- | --- | --- | --- | --- |
| Small LoBM | (0, 0, 2) | 0.314 | 0.979 | 0.942 |
| ME1 BM2 | (2, 0, 2) | 0.005 | 0.976 | 0.895 |
| Small HiBM | (2, 0, 2) | 0.002 | 0.980 | 0.932 |
| Big LoBM | (2, 0, 2) | 0.977 | 0.980 | 0.717 |
| ME2 BM2 | (2, 0, 2) | 0.057 | 0.980 | 0.565 |
| Big HiBM | (2, 0, 2) | 0.067 | 0.968 | 0.907 |

The mean dynamics are modest. Five of the six portfolios select ARIMA(2,0,2), while Small LoBM selects ARIMA(0,0,2). Residual diagnostics are acceptable for the larger, lower-volatility portfolios but remain weaker for ME1 BM2 and Small HiBM, which is why the report does not overstate the quality of purely univariate mean models. The variance dynamics are more striking. GARCH persistence lies between about 0.968 and 0.980 across the six series, and the ARCH-LM tests on standardized residuals are all comfortably insignificant, so the hand-rolled GARCH step removes most of the leftover second-moment dependence. That pattern aligns with the finance literature: monthly returns are hard to forecast in mean, but their volatility remains persistent.
...
Verified on **2026-04-11** using the linked publisher, journal, NBER, or official data-library pages.

## Data Source

- Kenneth R. French Data Library. "Data Library Home Page." Tuck School of Business at Dartmouth. The local course file used in this project is the six-portfolio size and book-to-market monthly return file. Verified against: https://mba.tuck.dartmouth.edu/pages/faculty/ken.french/data_library.html

## Academic References

1. Markowitz, Harry. 1952. "Portfolio Selection." *The Journal of Finance* 7 (1): 77-91. DOI: 10.1111/j.1540-6261.1952.tb01525.x. Verified against: https://law-journals-books.vlex.com/vid/portfolio-selection-855607006 and https://www.scirp.org/reference/referencespapers?referenceid=376023

2. Hamilton, James D. 1994. *Time Series Analysis*. Princeton, NJ: Princeton University Press. ISBN: 9780691042893. Verified against: https://www.bokus.com/bok/9780691042893/time-series-analysis/ and https://www.akademibokhandeln.se/bok/time-series-analysis/9780691042893

3. Engle, Robert F. 1982. "Autoregressive Conditional Heteroscedasticity with Estimates of the Variance of United Kingdom Inflation." *Econometrica* 50 (4): 987-1008. DOI: 10.2307/1912773. Verified against: https://www.econometricsociety.org/publications/econometrica/browse/1982/07/01/autoregressive-conditional-heteroscedasticity-estimates and https://cir.nii.ac.jp/crid/1362825895432662400

4. Bollerslev, Tim. 1986. "Generalized Autoregressive Conditional Heteroskedasticity." *Journal of Econometrics* 31 (3): 307-327. DOI: 10.1016/0304-4076(86)90063-1. Verified against: https://cir.nii.ac.jp/crid/1363388843673421440

5. Engle, Robert F., and Clive W. J. Granger. 1987. "Co-Integration and Error Correction: Representation, Estimation, and Testing." *Econometrica* 55 (2): 251-276. DOI: 10.2307/1913236. Verified against: https://www.econometricsociety.org/publications/econometrica/browse/1987/03/01/co-integration-and-error-correction-representation-estimation and https://econpapers.repec.org/RePEc:ecm:emetrp:v:55:y:1987:i:2:p:251-76

6. Fama, Eugene F., and Kenneth R. French. 1988. "Dividend Yields and Expected Stock Returns." *Journal of Financial Economics* 22 (1): 3-25. DOI: 10.1016/0304-405X(88)90020-7. Verified against: https://www.sciencedirect.com/science/article/abs/pii/0304405X88900207 and https://econpapers.repec.org/article/eeejfinec/v_3a22_3ay_3a1988_3ai_3a1_3ap_3a3-25.htm

7. Campbell, John Y., and Robert J. Shiller. 1988. "The Dividend-Price Ratio and Expectations of Future Dividends and Discount Factors." *The Review of Financial Studies* 1 (3): 195-228. Verified against: https://academic.oup.com/rfs/article-abstract/1/3/195/1580239 and https://www.nber.org/papers/w2100

8. Fama, Eugene F., and Kenneth R. French. 1993. "Common Risk Factors in the Returns on Stocks and Bonds." *Journal of Financial Economics* 33 (1): 3-56. DOI: 10.1016/0304-405X(93)90023-5. Verified against: https://www.sciencedirect.com/science/article/pii/0304405X93900235 and https://cir.nii.ac.jp/crid/1362262945860632192

9. Gatev, Evan, William N. Goetzmann, and K. Geert Rouwenhorst. 2006. "Pairs Trading: Performance of a Relative-Value Arbitrage Rule." *The Review of Financial Studies* 19 (3): 797-827. DOI: 10.1093/rfs/hhj020. Verified against: https://academic.oup.com/rfs/article/19/3/797/1646694?login=true and https://www.nber.org/papers/w7032

10. Jagannathan, Ravi, and Tongshu Ma. 2003. "Risk Reduction in Large Portfolios: Why Imposing the Wrong Constraints Helps." *The Journal of Finance* 58 (4): 1651-1684. DOI: 10.1111/1540-6261.00580. Verified against: https://www.scholars.northwestern.edu/en/publications/risk-reduction-in-large-portfolios-why-imposing-the-wrong-constra/ and https://www.nber.org/papers/w8922

11. Ledoit, Olivier, and Michael Wolf. 2004. "A Well-Conditioned Estimator for Large-Dimensional Covariance Matrices." *Journal of Multivariate Analysis* 88 (2): 365-411. DOI: 10.1016/S0047-259X(03)00096-4. Verified against: https://www.sciencedirect.com/science/article/pii/S0047259X03000964

12. DeMiguel, Victor, Lorenzo Garlappi, and Raman Uppal. 2009. "Optimal Versus Naive Diversification: How Inefficient Is the 1/N Portfolio Strategy?" *The Review of Financial Studies* 22 (5): 1915-1953. DOI: 10.1093/rfs/hhm075. Verified against: https://academic.oup.com/rfs/article/22/5/1915/1592901?login=false
